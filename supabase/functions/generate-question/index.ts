...
TEXTO: Escribe un texto de 180-280 palabras. Alterna entre estos géneros (no uses siempre el mismo):
...
DIFICULTAD: Problemas de 2-3 pasos encadenados. No operaciones de un solo paso. Ejemplos de complejidad adecuada:
...
DIFICULTAD: Problemas que requieren 2-3 pasos y selección del método correcto.

Temas: funciones (lineal, cuadrática, exponencial, logarítmica), trigonometría, vectores, geometría analítica, números complejos básicos.`,
    skills: {
      resolver:    'Resolver problemas avanzados con funciones, trigonometría o cálculo en contexto',
...
TIPO: Preguntas que exigen relacionar causas y consecuencias, interpretar fuentes, o evaluar procesos históricos. No solo memorización de fechas.`,
    skills: {
...
TIPO: Incluye preguntas que interpretan resultados de experimentos, analizan gráficos de datos, o aplican conceptos a situaciones nuevas. No solo definiciones.`,
    skills: {
...
[
  {
    "text": "${examId === 'lectora' ? 'TEXTO:\\n[texto de 180-280 palabras aquí]\\n\\nPREGUNTA:\\n[enunciado estilo DEMRE]' : '[enunciado del problema con contexto real]'}",
    "options": ["opción A", "opción B", "opción C", "opción D", "opción E"],
    "correct": 0,
    "skill": "${skillLabel}",
    "explanation": "${math ? 'Solución paso a paso: [calcula cada paso]. Resultado: [valor]. Esto corresponde a la opción [letra] (índice [número]), que es el campo correct declarado.' : 'Explicación de por qué la opción correcta es correcta y por qué cada distractor es incorrecto.'}"
  }
]
